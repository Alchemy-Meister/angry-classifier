python ./check_if_im_retarded.py \
    ./split/json/backup_japan/backup\ spell/fixed_tags/binary_anger_dataset_test.json \
...
python ./check_if_im_retarded.py \
    ./split/json/backup_japan/backup\ spell/fixed_tags/binary_anger_dataset_train.json \
...
python ./check_if_im_retarded.py \
    ./split/json/backup_japan/backup\ spell/fixed_tags/binary_anger_dataset_validation.json \
...
python ./check_if_im_retarded.py \
    ./split/json/backup_japan/backup\ spell/fixed_tags/binary_irony_dataset_test.json \
...
python ./check_if_im_retarded.py \
    ./split/json/backup_japan/backup\ spell/fixed_tags/binary_irony_dataset_train.json \
...
python ./check_if_im_retarded.py \
    ./split/json/backup_japan/backup\ spell/fixed_tags/binary_irony_dataset_validation.json \
